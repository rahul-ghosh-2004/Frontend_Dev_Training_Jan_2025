...
function Feature() {
  return (
    <div class="max-w-7xl mx-auto font-[sans-serif]">
      <div class="text-center max-w-2xl mx-auto">
        <h2 class="text-gray-800 sm:text-3xl text-2xl font-extrabold">Discover Our Exclusive Features</h2>
        <p class="text-sm text-gray-600 mt-6">Unlock a world of possibilities with our exclusive features. Explore how our unique offerings can transform your journey and empower you to achieve more.</p>
      </div>

      <div class="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 gap-12 mt-16">

        <div class="text-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 mb-6 inline-block bg-blue-100 p-3 rounded-xl" viewBox="0 0 32 32">
          ...
          <a href="javascript:void(0);" class="text-blue-600 font-bold inline-block text-sm mt-3 hover:underline">Learn more</a>
        </div>

        <div class="text-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 mb-6 inline-block bg-blue-100 p-3 rounded-xl" viewBox="0 0 682.667 682.667">
            <defs>
        ...
        <div class="text-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 mb-6 inline-block bg-blue-100 p-3 rounded-xl" viewBox="0 0 512.001 512.001">
        ...
        <div class="text-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 mb-6 inline-block bg-blue-100 p-3 rounded-xl" viewBox="0 0 24 24">
        ...
        <div class="text-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 mb-6 inline-block bg-blue-100 p-3 rounded-xl" viewBox="0 0 504.69 504.69">
          ...
          <p class="text-gray-600 text-sm">Expand your reach with our global network.</p>
          <a href="javascript:void(0);" class="text-blue-600 font-bold inline-block text-sm mt-3 hover:underline">Learn more</a>
        </div>
        ...
        <div class="text-center">
          ...
          <p class="text-gray-600 text-sm">Seamless communication for your team.</p>
          <a href="javascript:void(0);" class="text-blue-600 font-bold inline-block text-sm mt-3 hover:underline">Learn more</a>
        </div>

        <div class="text-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-12 mb-6 inline-block bg-blue-100 p-3 rounded-xl" viewBox="0 0 512 512">
          ...
          <h3 class="text-gray-800 text-xl font-semibold mb-3">Integration</h3>
          <p class="text-gray-600 text-sm">Seamlessly integrate with your existing tools and systems.</p>
          <a href="javascript:void(0);" class="text-blue-600 font-bold inline-block text-sm mt-3 hover:underline">Learn more</a>
        </div>
        ...
        <div class="text-center">
          ...
          <h3 class="text-gray-800 text-xl font-semibold mb-3">Scalability</h3>
          <p class="text-gray-600 text-sm">Easily scale your resources to meet growing demands.</p>
          <a href="javascript:void(0);" class="text-blue-600 font-bold inline-block text-sm mt-3 hover:underline">Learn more</a>
        </div>
      </div>
    </div>
